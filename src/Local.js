class Local {
    ...
    createStorage(name, data, time) {
        return new Promise((resolve) => {
            this.repeatedly_(20).then(res => {
                if (res) {
                    resolve(this.createStorage_(this.user_id+name, data, time));
                }
            });
        });
    }
    ...
    addStorage(name, data, time) {
        return new Promise((resolve) => {
            this.repeatedly_(20).then(res => {
                if (res) {
                    resolve(this.addStorage_(this.user_id+name, data, time));
                }
            });
        });
    }
    ...
    getStorage(name, id) {
        return new Promise((resolve) => {
            this.repeatedly_(20).then(res => {
                if (res) {
                    resolve(this.getStorage_(this.user_id+name, id));
                }
            });
        });
    }
    ...
    deleteStorage(name, id) {
        return new Promise((resolve) => {
            this.repeatedly_(20).then(res => {
                if (res) {
                    resolve(this.deleteStorage_(this.user_id+name, id));
                }
            });
        });
    }
